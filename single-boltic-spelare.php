		...
		<div class="row">
			...
			<main class="site-main" id="main">
				...
				<?php
					...
					echo '<ul><li class="border-right pr-4">Född: '; the_field('fodd'); echo '</li><li class="border-right pr-4 pl-4">Längd: '; the_field('langd'); echo '</li><li class="pl-4">'; the_field('position'); echo('<l/i></ul>');
